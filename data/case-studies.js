...
export const CASE_STUDIES = [
  ...
  {
    id: 'case-4', tag: 'HorrorIsland',
    title: 'A save system that protects itself from you',
    hook: 'Plug-and-play saves, with guardrails against editor mistakes.',
    problem: "As the only programmer on a 4-person team, a horror game needed a save/load system robust enough that designers and artists wouldn't need to understand it, and safe enough that accidental in-editor changes to data couldn't silently corrupt save-related state.",
